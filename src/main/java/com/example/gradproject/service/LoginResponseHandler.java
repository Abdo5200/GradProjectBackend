...
public interface LoginResponseHandler {
     ...
     * @param request      the HTTP request for reading existing cookies
     * @param response     the HTTP response for setting cookies
     * @return the login response with refresh token removed from body
     */
    LoginResponse handleLogin(LoginRequest loginRequest, HttpServletRequest request, HttpServletResponse response);
}
